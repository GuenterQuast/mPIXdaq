...
def run():
    ...
    out_filename = args.file + '_' + timestamp + '.npy' if args.file != '' else None
    ...
    axim.text(0.05, -0.055, f"integration time {int(integration_time)}s", transform=axim.transAxes, color="b")
